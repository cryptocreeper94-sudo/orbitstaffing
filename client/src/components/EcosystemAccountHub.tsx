...
const BONUSES: Bonus[] = [
  ...
  { id:'orbit',app:'ORBIT Staffing',icon:'🌐',headline:'ORBIT Member Drive',reward:'Onboard someone to ORBIT',sigAmount:1000,multiplier:'3×',perk:'Hallmark boost',url:'https://orbitstaffing.io',refParam:'ref',accent:'#0ea5e9',glow:'rgba(14,165,233,0.06)',start:'2026-04-07',end:'2026-04-21' },
  ...
  { id:'void',app:'THE VOID',icon:'🕳️',headline:'Void Explorers',reward:'Bring friends into THE VOID',sigAmount:400,multiplier:'2×',perk:'Void ID skin',url:'https://intothevoid.app',refParam:'ref',accent:'#0ea5e9',glow:'rgba(14,165,233,0.06)',start:'2026-06-02',end:'2026-06-16' },
...
const S: Record<string, CSSProperties> = {
  ...
  bonusMult:{display:'inline-flex',padding:'3px 8px',borderRadius:8,background:'linear-gradient(135deg,rgba(14,165,233,0.1),rgba(6,182,212,0.08))',border:'1px solid rgba(14,165,233,0.2)',fontSize:11,fontWeight:900,color:'#c4b5fd'},
  ...
  connBtn:{display:'inline-flex',alignItems:'center',gap:8,padding:isMobile?'14px 36px':'12px 32px',borderRadius:999,background:'linear-gradient(135deg,#06b6d4,#0ea5e9)',color:'#fff',fontSize:isMobile?15:14,fontWeight:700,textDecoration:'none',border:'none',cursor:'pointer',minHeight:isMobile?48:44},
      ...
      {open && (
        <div style={S.panel}>
          ...
          <div style={{...S.bonus,background:`linear-gradient(135deg,${bonus.glow},rgba(0,0,0,0.1))`}}>
            ...
            <a style={{...S.bonusCta,background:`linear-gradient(135deg,${bonus.accent},#0ea5e9)`}} href={refUrl(bonus,user?.name)} target="_blank" rel="noopener noreferrer">🚀 Refer & Earn</a>
          </div>
