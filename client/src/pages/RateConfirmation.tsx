          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="bg-sky-900/20 border border-sky-700/50 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  <Info className="w-5 h-5 text-sky-400 mt-1 flex-shrink-0" />
                  <div className="flex-1">
                    <h4 className="text-sky-300 font-bold mb-2">Estimated Total Cost</h4>
                    ...
                    <p className="text-sky-400 font-bold text-3xl" data-testid="text-estimated-cost">
