...
import { AlertCircle, MapPin, Clock, User, FileText, Send, ArrowLeft } from 'lucide-react';
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="flex items-center gap-3 mb-2">
            <AlertCircle className="w-7 sm:w-8 h-7 sm:h-8 text-red-600 flex-shrink-0" />
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Incident Reporting</h1>
          </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-4 sm:p-8 space-y-4 sm:space-y-6">
        ...
        <div className="mt-6 sm:mt-8 bg-yellow-50 border border-yellow-200 rounded-lg p-4 sm:p-6">
          <h3 className="font-bold text-gray-900 mb-2 text-sm sm:text-base">Why Incident Reporting Matters</h3>
