...
const TODO_TASKS = [
  {
    ...
    priority: 'HIGH',
    priorityBadge: '🔥 DO FIRST',
    priorityColor: 'red',
    why: 'Required for: CSA billing ($39/$99/$249 plans), garnishment payments, worker payouts',
    setupGuide: 'https://dashboard.stripe.com/apikeys',
    action: 'Get Stripe API keys',
    notes: [
      '✅ STATUS: Need to add keys',
      '',
      '📋 STEP-BY-STEP:',
      ...
      '5. Click "Reveal" on Secret key → starts with sk_live_',
      '6. In Replit: Go to Secrets tab (🔒 icon)',
      '7. Add: STRIPE_PUBLISHABLE_KEY = pk_live_xxx',
      '8. Add: STRIPE_SECRET_KEY = sk_live_xxx',
      '',
  ...
  },
  {
    ...
    priority: 'HIGH',
    priorityBadge: '🔥 DO SECOND',
    priorityColor: 'red',
    why: 'Required for: Payment confirmations, subscription updates, failed payment alerts',
    setupGuide: 'https://dashboard.stripe.com/webhooks',
    action: 'Create webhook endpoint',
    notes: [
      '✅ STATUS: Need after Stripe keys',
      '',
      '📋 STEP-BY-STEP:',
      '1. Go to: https://dashboard.stripe.com/webhooks',
      '2. Click "+ Add endpoint"',
      '3. Endpoint URL: https://YOUR-DOMAIN.replit.app/api/webhooks/stripe',
      '4. Select events: payment_intent.succeeded, invoice.paid, customer.subscription.*',
      '5. Click "Add endpoint"',
      '6. Click "Reveal" on Signing secret → starts with whsec_',
      '7. In Replit Secrets: Add STRIPE_WEBHOOK_SECRET = whsec_xxx',
    ],
  },
  {
    id: 'stripe-issuing',
