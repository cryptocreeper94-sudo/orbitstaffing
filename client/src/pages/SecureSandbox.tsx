        ...
        <div className="p-6 border-b border-slate-700 flex items-center justify-between bg-gradient-to-r from-purple-900/30 to-cyan-900/30">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-cyan-400 text-sm">ORBIT Staffing OS • v2.7.0 • Full Preview Access</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-yellow-500/30 rounded-lg p-4 relative overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <p className="font-mono text-yellow-400 text-sm">#000000000-01</p>
