...
export const allThemes: Theme[] = [
  // CLASSIC THEMES
  {
    ...
    colors: {
      ...
      secondary: "from-cyan-500 to-cyan-500",
      accent: "bg-cyan-500",
  ...
  },
  {
    ...
    colors: {
      ...
      secondary: "from-cyan-600 to-cyan-600",
      accent: "bg-cyan-600",
      background: "bg-black",
      cardBg: "bg-zinc-950",
      textPrimary: "text-white",
  ...
  },
  {
    ...
    colors: {
      ...
      secondary: "from-blue-600 to-sky-600",
      accent: "bg-blue-600",
      background: "bg-slate-900",
      cardBg: "bg-slate-800",
      textPrimary: "text-white",
  ...
  createTeamTheme("ravens", "Baltimore Ravens", "nfl", "https://content.sportslogos.net/logos/7/153/full/318.png", "from-sky-900 via-black to-sky-900", "from-sky-600 to-black", "bg-sky-700"),
  ...
  createTeamTheme("vikings", "Minnesota Vikings", "nfl", "https://content.sportslogos.net/logos/7/172/full/2704_minnesota_vikings-primary-2013.png", "from-sky-900 via-yellow-700 to-sky-900", "from-sky-600 to-yellow-500", "bg-sky-700"),
  ...
  createTeamTheme("rockies", "Colorado Rockies", "mlb", "https://content.sportslogos.net/logos/54/58/full/5765_colorado_rockies-primary-2017.png", "from-sky-900 via-slate-800 to-sky-900", "from-sky-600 to-black", "bg-sky-800"),
  ...
  createTeamTheme("hornets", "Charlotte Hornets", "nba", "https://content.sportslogos.net/logos/6/5120/full/1926_charlotte__hornets_-primary-2015.png", "from-teal-900 via-sky-800 to-teal-900", "from-teal-500 to-sky-500", "bg-teal-700"),
  ...
  createTeamTheme("lakers", "Los Angeles Lakers", "nba", "https://content.sportslogos.net/logos/6/237/full/uig7aiht8jnpl1szbi57zzlsh.png", "from-sky-900 via-yellow-700 to-sky-900", "from-sky-600 to-yellow-500", "bg-sky-600"),
  createTeamTheme("suns", "Phoenix Suns", "nba", "https://content.sportslogos.net/logos/6/238/full/phoenix_suns_logo_primary_20143696.png", "from-sky-900 via-orange-700 to-sky-900", "from-sky-600 to-orange-500", "bg-sky-700"),
  createTeamTheme("kings", "Sacramento Kings", "nba", "https://content.sportslogos.net/logos/6/240/full/4043_sacramento_kings-primary-2017.png", "from-sky-900 via-slate-800 to-sky-900", "from-sky-600 to-slate-600", "bg-sky-700"),
  ...
  },
  {
    ...
    colors: {
      primary: "from-indigo-900 via-sky-900 to-black",
      secondary: "from-sky-600 to-indigo-600",
      accent: "bg-sky-600",
      background: "bg-black",
  ...
  },
  {
    ...
    colors: {
      primary: "from-orange-900 via-sky-900 to-black",
      secondary: "from-orange-600 to-sky-600",
